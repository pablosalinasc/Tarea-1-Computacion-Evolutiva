...
% 
function Feat_Index =  Tarea1PIMA
%% Importar datasets
...
function [valor_fitness] = Fitness(string)
    ...
    if (contador>0)
        global PIMA
        columnasSeleccionadas=PIMA(1:end,lista_columnas);

...
global size_string
size_string=30;%Largo del string
...
function [valor_fitness] = Fitness(string)
    ...
    if (contador>0)
        global WBC
        columnasSeleccionadas=WBC(1:end,lista_columnas);
        clasificaciones=WBC(1:end,2);
